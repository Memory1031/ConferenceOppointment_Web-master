    ...
    <TabPane label="系统公告" icon="md-alert">
      <Row>
        <div class="button2">
          ...
          <Modal v-model="modal_create" title="发布公告">
            <p style="font-size: 15px; margin-bottom: 10px">请输入您要发布的系统公告：</p>
      ...
      <Row>
        ...
        <Modal v-model="modal_update" title="修改公告(请注意：修改公告将会更改发布时间！！！！)">
          <p style="font-size: 15px; margin-bottom: 10px">请修改系统公告:</p>
          <Input placeholder="请输入公告"  v-model="notice_create" maxlength="100" size="large" :rows="4" show-word-limit type="textarea"></Input>
          <div slot="footer">
                                ...
                                h('Button', {
                                    ...
                                    on: {
                                        click: () => {
                                            ...
                                            this.notice_create = this.data2[params.index].content;
                                        }
                                    }
                                }, '修改'),
                                h('Button', {
        ...
        methods:{
            ...
            createNotice(){
                ...
                if(!this.notice_create){
                    ...
                    axios({
                        url: apiRoot + '/system/noticeCreation',
                        method: 'post',
                        data:{
            ...
            updateNotice(){
                ...
                if(this.notice_create == ''){
                    ...
                    axios({
                        url: apiRoot + '/system/noticeUpdate',
                        method: 'post',
                        data:{
                            content: this.notice_create,
                            id: this.data2[this.notice_update_number].id
                        }
                    }).then((res) => {
                        if(res.data.code == 200){
            ...
            deleteAnnouncement(index){
                ...
                axios({
                    url: apiRoot + '/system/noticeDeletion?id=' + this.data2[this.notice_delete_number].id,
                    method: 'get'
                }).then((res) => {
                    if(res.data.code == 200){
