  ...
  <div>
    <Row>
      <div class="button">
        ...
        <Button type="primary" @click="modal_create=true">新增系统管理员</Button>
    ...
    <Row>
      ...
      <Modal v-model="modal_delete"  width="550">
        ...
        <div style="text-align:center;font-size: 16px;">
          ...
          <br/><br/>
          <p>在进行此操作后，<span id="manager-name"></span>将会被取消系统管理员资格</p>
          <p>您确定要删除么</p>
        </div>
        <div slot="footer">
    ...
    export default{
        ...
        methods:{
            ...
            del(){
                ...
                axios({
                    url: apiRoot + '/system/systemDeletion?userId=' + this.data[this.deletingManager].userId,
                    method: 'get'
                }).then((res) => {
                    if(res.data.code == 200){
            ...
            createManager(){
                ...
                axios({
                    url: apiRoot + '/system/systemSetting',
                    method: 'post',
                    data:{
                        userList : this.items
                    }
