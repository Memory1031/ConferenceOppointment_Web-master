    ...
    <div class="info-person-department">
      <van-collapse v-model="activeNames" border>
        ...
        <van-collapse-item title="选择身份" name="3" v-if="isManager">
          ...
          <span slot="title">&nbsp&nbsp&nbsp&nbsp选择身份 （当前身份：用户）</span>
          <div>
            <van-radio-group v-model="radio">
              <van-cell-group>
                <van-cell title="普通用户" clickable @click="radio = '1'">
                  <van-radio slot="right-icon" name="1" />
                </van-cell>
                <van-cell title="管理员" clickable @click="radio = '2', $router.push('/mobile/managerMobile')">
